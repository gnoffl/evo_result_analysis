...
#         self.assertIn((1, "A", "C"), mutations)
#         self.assertIn((2, "A", "G"), mutations)
...
#         self.assertIn("binding_changed", result.columns)
#         self.assertIn("max_delta", result.columns)
        
#         # Check delta columns exist
#         for tf_name in TF_FAMILY_NAMES[:2]:
#             self.assertIn(f"delta_tf_{tf_name}", result.columns)
...
#         for tf_name in TF_FAMILY_NAMES[:2]:
#             self.assertIn(f"tf_{tf_name}_ref", result.columns)
#             self.assertIn(f"tf_{tf_name}_max_mut", result.columns)
...
#         self.assertIn("mutations_in_window", result.columns)
#         self.assertIn("n_mutations_in_window", result.columns)
...
#         self.assertIn("chromosome", result.columns)
#         self.assertIn("strand", result.columns)
#         self.assertIn("genomic_window_start", result.columns)
#         self.assertIn("genomic_window_end", result.columns)
...
#         self.assertIsNone(result.iloc[0]["genomic_window_start"])
...
#         self.assertIn("binding_changed", compared.columns)
...
#         self.assertIn("mutations_in_window", annotated.columns)
        
#         # Step 3: Add genomic coordinates
#         final = add_genomic_coordinates(annotated)
#         self.assertIn("genomic_window_start", final.columns)
